    ...
    <div className="main-content">
      ...
      <div className="dashboard-grid" style={{ marginBottom: "1rem" }}>
        {[
          ...
          ["Invoices del periodo", metrics.periodInvoices],
          ["Eligible referrals", metrics.periodEligibleReferrals],
          ["Importe final periodo", `PLN ${metrics.periodFinalAmount.toFixed(2)}`],
        ].map(([label, value]) => (
