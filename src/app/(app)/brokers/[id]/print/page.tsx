  ...
  return (
    <div className="main-content" style={{ maxWidth: 1200 }}>
      ...
      <div className="no-print" style={{ marginBottom: "1rem" }}>
        <a className="button button-secondary" href={`/brokers/${broker.id}`}>Volver</a>
      </div>
      ...
      <div className="dashboard-grid" style={{ marginBottom: "1rem" }}>
        <div className="card print-card"><h3>Status</h3><BrokerStatusBadge value={broker.status} /></div>
        <div className="card print-card"><h3>Referrals</h3><div style={{ fontSize: "2rem", fontWeight: 900 }}>{broker.metrics.totalReferrals}</div></div>
        <div className="card print-card"><h3>Elegibles</h3><div style={{ fontSize: "2rem", fontWeight: 900 }}>{broker.metrics.eligibleReferrals}</div></div>
        <div className="card print-card"><h3>Final total</h3><div style={{ fontSize: "2rem", fontWeight: 900 }}>PLN {broker.metrics.finalAmountTotal.toFixed(2)}</div></div>
      </div>
